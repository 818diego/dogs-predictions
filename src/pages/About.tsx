import { HeartIcon, ShieldCheckIcon, AcademicCapIcon } from '@heroicons/react/24/outline';
    ...
    <div className="py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-3xl mx-auto text-center mb-20">
        ...
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-6">
          ...
          <span className="block text-indigo-600 dark:text-indigo-400">mejor amigo</span>
        </h1>
        <p className="text-xl text-gray-600 dark:text-gray-300">
          Utilizamos inteligencia artificial avanzada para ayudarte a entender y cuidar mejor a tu mascota
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-24">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <Stat number="150+" label="Razas Identificables" />
          <Stat number="98%" label="Precisión" />
          <Stat number="24/7" label="Disponibilidad" />
          <Stat number="10k+" label="Usuarios Activos" />
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto mt-24 text-center">
        <blockquote className="text-xl italic text-gray-700 dark:text-gray-300">
          "Nuestra misión es hacer que la tecnología sea accesible y útil para todos los amantes de los perros, 
          ayudándoles a proporcionar el mejor cuidado posible a sus mascotas."
        </blockquote>
      </div>
    </div>
  );
...
function Stat({ number, label }: { number: string; label: string }) {
  return (
    <div className="text-center p-6 bg-white dark:bg-gray-800/50 rounded-2xl">
